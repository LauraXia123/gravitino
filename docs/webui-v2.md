...
Starting with version 1.2.0, Gravitino introduces Web V2. By default, `GRAVITINO_USE_WEB_V2` is set to `false`, which uses Web V1. If you want to enable Web V2, set the following environment variable in `conf/gravitino-env.sh` before starting the server:
...
- When `gravitino.authorization.enable=false`, authorization is disabled. In `simple` mode, the UI opens directly to the metalake list page.
  ...
  ![metalakes-list](./assets/webui-v2/metalakes-list-new.png)
...
![create-metalake](./assets/webui-v2/create-metalake-new.png)
...
![metalake-properties-popover](./assets/webui-v2/metalake-properties-popover-new.png)
...
![metalake-actions](./assets/webui-v2/metalake-actions-new.png)

#### Delete metalake (Web V2)

To delete a metalake, the metalake must be **not in-use**, and all sub-entities must be deleted first. The delete dialog requires entering the metalake name for confirmation before deletion.

![metalake-delete-confirm](./assets/webui-v2/metalake-delete-confirm-new.png)

### Catalogs (Web V2)

Overview for Catalog in the Web V2.

#### Navigate to catalogs (Web V2)

From the metalake list, click a metalake name in the **Metalake Name** column to open its catalogs page.
...
![catalogs-list](./assets/webui-v2/catalogs-list-new.png)
...
![catalogs-create-step1](./assets/webui-v2/create-catalog-step1-new.png)

![catalogs-create-step2](./assets/webui-v2/create-catalog-step2-new.png)
...
![navbar-system-mode](./assets/webui-v2/navbar-system-mode-new.png)
![navbar-user-dropdown](./assets/webui-v2/navbar-user-dropdown-new.png)
...
![schemas-list](./assets/webui-v2/schemas-list-new.png)

#### Associated Roles (Web V2)

Overview for Associated Roles in the Web V2. (visible only when `gravitino.authorization.enable=true`)

![catalog-associated-roles](./assets/webui-v2/catalog-associated-roles-new.png)

### Tables (Web V2)

Overview for Table in the Web V2.

![tables-list](./assets/webui-v2/tables-list-new.png)
...
![tables-create-columns](./assets/webui-v2/create-table-new.png)
![tables-create-columns2](./assets/webui-v2/create-table-new2.png)
![tables-create-sorderOrders](./assets/webui-v2/create-table-sortOrders-new.png)
...
![filesets-list](./assets/webui-v2/filesets-list-new.png)

Overview for files under fileset in the Web V2.

![files-list](./assets/webui-v2/files-list-new.png)

### Topics (Web V2)

Overview for Topic in the Web V2.

![topics-list](./assets/webui-v2/topics-list-new.png)

### Models (Web V2)

Overview for Model in the Web V2.

![models-list](./assets/webui-v2/models-list-new.png)

### Versions (Web V2)

Overview for Version in the Web V2.

![versions-list](./assets/webui-v2/versions-list-new.png)

### Job (Web V2)

Overview for Job in the Web V2.

![jobs-list](./assets/webui-v2/jobs-list-new.png)
...
![run-job](./assets/webui-v2/run-job-new.png)
...
![run-job](./assets/webui-v2/run-job-new2.png)

### Job Template (Web V2)

Overview for Job Template in the Web V2.

![jobTemplates-list](./assets/webui-v2/jobTemplates-list-new.png)
...
![job-template-register](./assets/webui-v2/job-template-register-new.png)
...
![tag-metadata-objects](./assets/webui-v2/tag-metadata-objects-new.png)

### Data Compliance - Policies (Web V2)

Overview for Data Compliance Policies in the Web V2.

![policies-list](./assets/webui-v2/policies-list-new.png)
...
![policies-create](./assets/webui-v2/policies-create-new.png)
...
![policy-metadata-objects](./assets/webui-v2/policy-metadata-objects-new.png)
...
![userGroups-add](./assets/webui-v2/userGroups-add-new.png)

#### Grant Role (Web V2)

From the **Actions**, click **Grant Role** icon to assign roles to the selected user group.

![userGroups-grant-role](./assets/webui-v2/userGroups-grant-role-new.png)

### Access - Roles (Web V2)

Overview for Access Roles in the Web V2.

![roles-list-new](./assets/webui-v2/roles-list-new.png)
...
![roles-create](./assets/webui-v2/roles-create-new.png)
